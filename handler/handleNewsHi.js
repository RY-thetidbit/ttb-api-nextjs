...
async function getUpBiharNews() {
  ...
  const apiResJsonUP = await parse('https://hindi.news18.com/rss/khabar/uttar-pradesh/uttar-pradesh.xml');

  const apiResJsonBihar = await parse('https://hindi.news18.com/rss/khabar/bihar/bihar.xml');
